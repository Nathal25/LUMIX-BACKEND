 ...
 * @access Public
 */
router.get("/search", (req, res) => PexelsController.searchMedia(req, res));
 ...
 * @access Public
 */
router.get("/popular", (req, res) => PexelsController.getPopularVideos(req, res));
